...
#include "PhaderReader.h"	// Implementación de sensores Phader
#include "SwitchReader.h"	// Implementación de switch
...
void SensorManager::addSensor(SensorType type, uint8_t pin) {
    ISensor* sensor = nullptr;
        ...
        case SensorType::DotFSR:
            ...
            break;
        case SensorType::Phader:
            sensor = new PhaderReader(pin);  
            break;
        case SensorType::Switch:
            sensor = new SwitchReader(pin);  
            break;
        default:
